...
TAG = 'phase2_manual_curated_seed_v1'
...
SEEDS = [
    {
        ...
        'transformation_text': 'Curated representative seed: non-enolizable benzaldehyde undergoes Cannizzaro disproportionation under strong base to benzyl alcohol and benzoate.',
        'reactants_text': 'benzaldehyde',
        'products_text': 'benzyl alcohol | benzoic acid',
        'reagents_text': 'sodium hydroxide',
        'conditions_text': 'curated representative seed from textbook canonical overview',
        'notes_text': 'Manual curated seed built from the canonical overview page to provide concrete queryable structure evidence for the family. Simplified representative substrate capturing the aldehyde disproportionation logic. [' + TAG + ']',
        'molecules': [
            ('reactant', 'O=Cc1ccccc1', 'benzaldehyde', 'reactants_text'),
            ('product', 'OCc1ccccc1', 'benzyl alcohol', 'products_text'),
            ('product', 'O=C(O)c1ccccc1', 'benzoic acid', 'products_text'),

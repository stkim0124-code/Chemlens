...
ALIAS_RESIDUES = {'Furukawa Modification': ['Furukawa Simmons-Smith Modification'], 'Gattermann and Gattermann-Koch Formylation': ['Gattermann Formylation', 'Gattermann-Koch Formylation'], 'Hunsdiecker Reaction': ['Hunsdiecker-Borodin Reaction'], 'Jacobsen-Katsuki Epoxidation': ['Katsuki-Jacobsen Epoxidation', 'Jacobsen-Katsuki Reaction'], 'Jones Oxidation': ['Jones Oxidation/Oxidation of Alcohols by Chromium Reagents'], 'Jacobsen Hydrolytic Kinetic Resolution': ['Jacobsen HKR', 'Hydrolytic Kinetic Resolution'], 'Johnson-Claisen Rearrangement': ['Johnson Claisen Rearrangement'], 'Japp-Klingemann Reaction': ['Japp Klingemann Reaction'], 'Horner-Wadsworth-Emmons Olefination – Still-Gennari Modification': ['Still-Gennari Modification', 'Still-Gennari Olefination'], 'Julia-Lythgoe Olefination': ['Julia-Lythgoe Reaction']}
TAG = 'phase14_shallow_top10_completion_'
...
def main() -> int:
    ap=argparse.ArgumentParser(description='Verify shallow-family sprint phase14 top10 in 5+5 batches.')
    ap.add_argument('--db', default='app/labint.db')
    ap.add_argument('--report-dir', default='reports/family_completion_phase14_shallow_top10_verify')

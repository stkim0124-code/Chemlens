...
SEEDS_BY_BATCH: Dict[str, List[Dict[str, Any]]] = {
    'a': [
        ...
        },
        {
            'family': 'Stille-Kelly Coupling',
            'extract_kind': 'application_example',
            'transformation_text': 'Stille-Kelly intramolecular biaryl ring closure.',
            'reactants_text': "4,4'-dibromo-biphenyl",
            'products_text': 'biphenylene (ring-closed biaryl)',
            ...
            'molecules': [
                ('reactant', 'Brc1ccc(-c2ccc(Br)cc2)cc1', "4,4'-dibromo-biphenyl", 'reactants_text', 1),
                ('product', 'c1ccc2c(c1)-c1ccccc1-2', 'biphenylene (ring-closed biaryl)', 'products_text', 1),
            ],
        },
        # === Stobbe Condensation ===
        {

...
SEEDS_BY_BATCH: Dict[str, List[Dict[str, Any]]] = {
    ...
    'b': [
        ...
        # === Meerwein Arylation ===
        {
            ...
            'extract_kind': 'application_example',
            'transformation_text': 'Meerwein arylation: aryl radical from benzenediazonium chloride adds to activated alkene (methyl acrylate) with chloride transfer.',
            'reactants_text': 'methyl acrylate',
            'products_text': 'methyl 3-chloro-3-phenylpropanoate',
            'reagents_text': 'benzenediazonium chloride, CuCl2 (cat.), NaOAc',
        ...
        },
        {
            'family': 'Meerwein Arylation',
            'extract_kind': 'application_example',
            'transformation_text': 'Meerwein arylation of acrylonitrile with p-chloroaryl diazonium salt giving β-chloronitrile.',
            'reactants_text': 'acrylonitrile',
            'products_text': '3-chloro-3-(4-chlorophenyl)propanenitrile',
            'reagents_text': '4-chlorobenzenediazonium chloride, CuCl2, NaOAc',
        ...
        },
        {
            'family': 'Meerwein Arylation',
            'extract_kind': 'application_example',
            'transformation_text': 'Meerwein arylation: p-methoxybenzenediazonium aryl radical adds to phenyl vinyl ketone with chloride quench.',
            'reactants_text': 'phenyl vinyl ketone',
            'products_text': '3-chloro-3-(4-methoxyphenyl)-1-phenylpropan-1-one',
            'reagents_text': '4-methoxybenzenediazonium chloride, CuCl2, NaOAc',
            ...
            'molecules': [
                ('reactant', 'C=CC(=O)c1ccccc1', 'phenyl vinyl ketone', 'reactants_text', 1),
                ('product', 'COc1ccc(CC(Cl)C(=O)c2ccccc2)cc1', '3-chloro-3-(4-methoxyphenyl)-1-phenylpropan-1-one', 'products_text', 1),
            ],
        },
        # === Meerwein-Ponndorf-Verley Reduction ===
        {

...
SEEDS_BY_BATCH: Dict[str, List[Dict[str, Any]]] = {
    'a': [
        ...
        },
        {
            'family': 'Smiles Rearrangement',
            'extract_kind': 'application_example',
            'transformation_text': 'Smiles-type rearrangement driven by nitro group on aryl.',
            'reactants_text': 'benzyl p-nitrobenzoate with amine tether (simplified aryl O ester)',
            'products_text': 'p-nitrobenzamide isomer (Smiles rearranged)',
            'reagents_text': 'NaH / DMF',
            'conditions_text': 'rt',
            ...
            'molecules': [
                ('reactant', 'O=C(OCc1ccccc1)c2ccc([N+](=O)[O-])cc2', 'benzyl p-nitrobenzoate with amine tether (simplified aryl O ester)', 'reactants_text', 1),
                ('product', 'O=C(NCc1ccccc1)c2ccc([N+](=O)[O-])cc2', 'p-nitrobenzamide isomer (Smiles rearranged)', 'products_text', 1),
            ],
        },
        {
            'family': 'Smiles Rearrangement',

...
SEEDS_BY_BATCH: Dict[str, List[Dict[str, Any]]] = {
    'a': [
        ...
        },
        {
            'family': 'Pinacol and Semipinacol Rearrangement',
            'extract_kind': 'application_example',
            'transformation_text': 'Pinacol/semipinacol on unsymmetric diol to branched ketone.',
            'reactants_text': 'tertiary-secondary diol (branched)',
            'products_text': 'pinacolone-type ketone',
            ...
            'molecules': [
                ('reactant', 'OC(C)(C)C(OH)C1CCCCC1', 'tertiary-secondary diol (branched)', 'reactants_text', 1),
                ('product', 'CC(C)=O', 'pinacolone-type ketone', 'products_text', 1),
            ],
        },
        # === Pinner Reaction ===
        {

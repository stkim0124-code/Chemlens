...
TAG = 'phase16_shallow_top10_completion_v1'
...
SEEDS_BY_BATCH: Dict[str, List[Dict[str, Any]]] = {
    'a': [
        # --- Baldwin's Rules ---
        {
            ...
            'transformation_text': "Application example: 5-exo-tet cyclization of 4-bromo-1-butanol to tetrahydrofuran illustrates a favored Baldwin ring closure.",
            'reactants_text': '4-bromo-1-butanol',
            'products_text': 'tetrahydrofuran',
            'reagents_text': 'base',
            'conditions_text': 'curated application-class seed illustrating an allowed 5-exo-tet closure under Baldwin guidelines',
            'notes_text': "Manual curated application-class seed added during the phase16 5+5 shallow-family completion sprint for Baldwin's Rules. [phase16_shallow_top10_completion_v1]",
            'molecules': [
                ('reactant', 'OCCCCBr', '4-bromo-1-butanol', 'reactants_text', 1),
                ('product', 'C1CCOC1', 'tetrahydrofuran', 'products_text', 1),
            ],
        },
        {
            'family': "Baldwin's Rules / Guidelines for Ring-Closing Reactions",
            'extract_kind': 'application_example',
            'transformation_text': "Application example: 6-exo-tet cyclization of 5-bromo-1-pentanol to tetrahydropyran illustrates a second favored Baldwin ring closure.",
            'reactants_text': '5-bromo-1-pentanol',
            'products_text': 'tetrahydropyran',
            'reagents_text': 'base',
            'conditions_text': 'curated application-class seed illustrating an allowed 6-exo-tet closure under Baldwin guidelines',
            'notes_text': "Manual curated application-class seed added during the phase16 5+5 shallow-family completion sprint for Baldwin's Rules. [phase16_shallow_top10_completion_v1]",
            'molecules': [
        ...
        # --- Dimroth Rearrangement ---
        {
            ...
            'extract_kind': 'application_example',
            'transformation_text': 'Application example: Dimroth rearrangement of 1-methyl-N-methyl-4-amino-1,2,3-triazole to the 2-methyl regioisomer.',
            'reactants_text': '1-methyl-N-methyl-4-amino-1,2,3-triazole',
            'products_text': '2-methyl-N-methyl-4-amino-1,2,3-triazole',
            'reagents_text': 'base, heat',
            'conditions_text': 'curated application-class seed representing Dimroth triazole regioisomer interconversion',
            'notes_text': 'Manual curated application-class seed added during the phase16 5+5 shallow-family completion sprint for Dimroth rearrangement. [phase16_shallow_top10_completion_v1]',
            'molecules': [
                ('reactant', 'CNc1cn(C)nn1', '1-methyl-N-methyl-4-amino-1,2,3-triazole', 'reactants_text', 1),
                ('product', 'CNc1cnn(C)n1', '2-methyl-N-methyl-4-amino-1,2,3-triazole', 'products_text', 1),
            ],
        },
        {
            'family': 'Dimroth Rearrangement',
            'extract_kind': 'application_example',
            'transformation_text': 'Application example: Dimroth rearrangement of 1-phenyl-N-methyl-4-amino-1,2,3-triazole to the 2-phenyl regioisomer.',
            'reactants_text': '1-phenyl-N-methyl-4-amino-1,2,3-triazole',
            'products_text': '2-phenyl-N-methyl-4-amino-1,2,3-triazole',
            'reagents_text': 'base, heat',
            'conditions_text': 'curated application-class seed adding an N-aryl triazole Dimroth example',
            'notes_text': 'Manual curated application-class seed added during the phase16 5+5 shallow-family completion sprint for Dimroth rearrangement. [phase16_shallow_top10_completion_v1]',
            'molecules': [
        ...
        # --- Doering-Laflamme Allene Synthesis ---
        {
            ...
            'extract_kind': 'application_example',
            'transformation_text': 'Application example: Doering-Laflamme synthesis converts 1,1-dibromo-2-methylcyclopropane to 1,2-butadiene (methylallene).',
            'reactants_text': '1,1-dibromo-2-methylcyclopropane',
            'products_text': '1,2-butadiene',
            'reagents_text': 'alkyllithium',
            'conditions_text': 'curated application-class seed representing gem-dibromocyclopropane to allene conversion',
            'notes_text': 'Manual curated application-class seed added during the phase16 5+5 shallow-family completion sprint for Doering-Laflamme allene synthesis. [phase16_shallow_top10_completion_v1]',
            'molecules': [
                ('reactant', 'CC1CC1(Br)Br', '1,1-dibromo-2-methylcyclopropane', 'reactants_text', 1),
                ('product', 'CC=C=C', '1,2-butadiene', 'products_text', 1),
            ],
        },
        {
            'family': 'Doering-Laflamme Allene Synthesis',
            'extract_kind': 'application_example',
            'transformation_text': 'Application example: Doering-Laflamme synthesis converts 1,1-dibromo-2,3-dimethylcyclopropane to 2,3-pentadiene.',
            'reactants_text': '1,1-dibromo-2,3-dimethylcyclopropane',
            'products_text': '2,3-pentadiene',
            'reagents_text': 'alkyllithium',
            'conditions_text': 'curated application-class seed adding a disubstituted cyclopropane to allene example',
            'notes_text': 'Manual curated application-class seed added during the phase16 5+5 shallow-family completion sprint for Doering-Laflamme allene synthesis. [phase16_shallow_top10_completion_v1]',
            'molecules': [
        ...
        # --- Dötz Benzannulation ---
        {
            ...
            'extract_kind': 'application_example',
            'transformation_text': 'Application example: Dötz benzannulation of 2-butyne with a Fischer carbene yields a 2,6-dimethylphenol framework.',
            'reactants_text': '2-butyne',
            'products_text': '2,6-dimethylphenol',
            'reagents_text': 'chromium Fischer carbene complex, CO',
            'conditions_text': 'curated application-class seed representing Dötz phenol construction from a symmetrical alkyne',
            'notes_text': 'Manual curated application-class seed added during the phase16 5+5 shallow-family completion sprint for Dötz benzannulation. [phase16_shallow_top10_completion_v1]',
            'molecules': [
                ('reactant', 'CC#CC', '2-butyne', 'reactants_text', 1),
                ('product', 'Cc1cccc(C)c1O', '2,6-dimethylphenol', 'products_text', 1),
            ],
        },
        {
            'family': 'Dötz Benzannulation Reaction',
            'extract_kind': 'application_example',
            'transformation_text': 'Application example: Dötz benzannulation of 2-pentyne with a Fischer carbene yields a 2-ethyl-6-methylphenol framework.',
            'reactants_text': '2-pentyne',
            'products_text': '2-ethyl-6-methylphenol',
            'reagents_text': 'chromium Fischer carbene complex, CO',
            'conditions_text': 'curated application-class seed adding an unsymmetrical alkyne Dötz example',
            'notes_text': 'Manual curated application-class seed added during the phase16 5+5 shallow-family completion sprint for Dötz benzannulation. [phase16_shallow_top10_completion_v1]',
            'molecules': [
        ...
        # --- Enders SAMP/RAMP Hydrazone Alkylation ---
        {
            ...
            'extract_kind': 'application_example',
            'transformation_text': 'Application example: Enders SAMP-mediated asymmetric α-methylation of cyclohexanone to 2-methylcyclohexanone.',
            'reactants_text': 'cyclohexanone',
            'products_text': '2-methylcyclohexanone',
            'reagents_text': 'SAMP, base, methyl iodide, then hydrolysis',
            'conditions_text': 'curated application-class seed representing α-alkylation via SAMP/RAMP hydrazone',
            'notes_text': 'Manual curated application-class seed added during the phase16 5+5 shallow-family completion sprint for Enders SAMP/RAMP. [phase16_shallow_top10_completion_v1]',
            'molecules': [
                ('reactant', 'O=C1CCCCC1', 'cyclohexanone', 'reactants_text', 1),
                ('product', 'CC1CCCCC1=O', '2-methylcyclohexanone', 'products_text', 1),
            ],
        },
        {
            'family': 'Enders SAMP/RAMP Hydrazone Alkylation',
            'extract_kind': 'application_example',
            'transformation_text': 'Application example: Enders SAMP-mediated asymmetric α-methylation of pentan-2-one to 3-methylpentan-2-one.',
            'reactants_text': 'pentan-2-one',
            'products_text': '3-methylpentan-2-one',
            'reagents_text': 'SAMP, base, methyl iodide, then hydrolysis',
            'conditions_text': 'curated application-class seed adding an acyclic ketone SAMP/RAMP example',
            'notes_text': 'Manual curated application-class seed added during the phase16 5+5 shallow-family completion sprint for Enders SAMP/RAMP. [phase16_shallow_top10_completion_v1]',
            'molecules': [
    ...
    'b': [
        # --- Eschenmoser Methenylation ---
        {
            ...
            'extract_kind': 'application_example',
            'transformation_text': "Application example: Eschenmoser's salt promotes net α-methylenation of cyclohexanone to 2-methylenecyclohexanone.",
            'reactants_text': 'cyclohexanone',
            'products_text': '2-methylenecyclohexanone',
            'reagents_text': "Eschenmoser's salt (N,N-dimethylmethyleneammonium iodide), base, then elimination",
            'conditions_text': 'curated application-class seed representing α-methylenation via Mannich/elimination sequence',
            'notes_text': 'Manual curated application-class seed added during the phase16 5+5 shallow-family completion sprint for Eschenmoser methenylation. [phase16_shallow_top10_completion_v1]',
            'molecules': [
                ('reactant', 'O=C1CCCCC1', 'cyclohexanone', 'reactants_text', 1),
                ('product', 'C=C1CCCCC1=O', '2-methylenecyclohexanone', 'products_text', 1),
            ],
        },
        {
            'family': 'Eschenmoser Methenylation',
            'extract_kind': 'application_example',
            'transformation_text': "Application example: Eschenmoser methenylation of propiophenone to α-methyleneacrylophenone (2-methylene-1-phenyl-propan-1-one).",
            ...
            'conditions_text': 'curated application-class seed adding an aryl-alkyl ketone methenylation example',
            'notes_text': 'Manual curated application-class seed added during the phase16 5+5 shallow-family completion sprint for Eschenmoser methenylation. [phase16_shallow_top10_completion_v1]',
            'molecules': [
        ...
        # --- Eschenmoser-Tanabe Fragmentation ---
        {
            ...
            'extract_kind': 'application_example',
            'transformation_text': 'Application example: Eschenmoser-Tanabe fragmentation of 2,3-epoxycyclohexan-1-one tosylhydrazone yields hex-5-ynal.',
            'reactants_text': '2,3-epoxycyclohexan-1-one',
            'products_text': 'hex-5-ynal',
            'reagents_text': 'p-toluenesulfonylhydrazine, then base',
            'conditions_text': 'curated application-class seed representing epoxy-ketone fragmentation to alkynal',
            'notes_text': 'Manual curated application-class seed added during the phase16 5+5 shallow-family completion sprint for Eschenmoser-Tanabe fragmentation. [phase16_shallow_top10_completion_v1]',
            'molecules': [
                ('reactant', 'O=C1CCCC2OC12', '2,3-epoxycyclohexan-1-one', 'reactants_text', 1),
                ('product', 'O=CCCCC#C', 'hex-5-ynal', 'products_text', 1),
            ],
        },
        {
            'family': 'Eschenmoser-Tanabe Fragmentation',
            'extract_kind': 'application_example',
            'transformation_text': 'Application example: Eschenmoser-Tanabe fragmentation of 2,3-epoxycyclopentan-1-one tosylhydrazone yields pent-4-ynal.',
            'reactants_text': '2,3-epoxycyclopentan-1-one',
            'products_text': 'pent-4-ynal',
            'reagents_text': 'p-toluenesulfonylhydrazine, then base',
            'conditions_text': 'curated application-class seed adding a smaller-ring epoxy-ketone fragmentation example',
            'notes_text': 'Manual curated application-class seed added during the phase16 5+5 shallow-family completion sprint for Eschenmoser-Tanabe fragmentation. [phase16_shallow_top10_completion_v1]',
            'molecules': [
        ...
        # --- Favorskii Rearrangement ---
        {
            ...
            'extract_kind': 'application_example',
            'transformation_text': 'Application example: Favorskii rearrangement of 2-chlorocyclohexan-1-one to cyclopentanecarboxylic acid via ring contraction.',
            'reactants_text': '2-chlorocyclohexan-1-one',
            'products_text': 'cyclopentanecarboxylic acid',
            'reagents_text': 'aqueous NaOH',
            'conditions_text': 'curated application-class seed representing α-halo-ketone ring contraction',
            'notes_text': 'Manual curated application-class seed added during the phase16 5+5 shallow-family completion sprint for Favorskii rearrangement. [phase16_shallow_top10_completion_v1]',
            'molecules': [
                ('reactant', 'O=C1CCCCC1Cl', '2-chlorocyclohexan-1-one', 'reactants_text', 1),
                ('product', 'O=C(O)C1CCCC1', 'cyclopentanecarboxylic acid', 'products_text', 1),
            ],
        },
        {
            'family': 'Favorskii and Homo-Favorskii Rearrangement',
            'extract_kind': 'application_example',
            'transformation_text': 'Application example: Favorskii rearrangement of 1-chloropropan-2-one to propionic acid via a cyclopropanone intermediate.',
            'reactants_text': '1-chloropropan-2-one',
            'products_text': 'propionic acid',
            'reagents_text': 'aqueous NaOH',
            'conditions_text': 'curated application-class seed adding a simple acyclic α-halo-ketone Favorskii example',
            'notes_text': 'Manual curated application-class seed added during the phase16 5+5 shallow-family completion sprint for Favorskii rearrangement. [phase16_shallow_top10_completion_v1]',
            'molecules': [
        ...
        # --- Grob Fragmentation ---
        {
            ...
            'extract_kind': 'application_example',
            'transformation_text': 'Application example: Grob fragmentation of 4-bromo-2-(dimethylamino)butane yields propene (and an iminium fragment).',
            'reactants_text': '4-bromo-2-(dimethylamino)butane',
            'products_text': 'propene',
            'reagents_text': 'base',
            'conditions_text': 'curated application-class seed representing γ-amino-halide Grob fragmentation to alkene',
            'notes_text': 'Manual curated application-class seed added during the phase16 5+5 shallow-family completion sprint for Grob fragmentation. [phase16_shallow_top10_completion_v1]',
            'molecules': [
                ('reactant', 'CC(N(C)C)CCBr', '4-bromo-2-(dimethylamino)butane', 'reactants_text', 1),
                ('product', 'CC=C', 'propene', 'products_text', 1),
            ],
        },
        {
            'family': 'Grob Fragmentation',
            'extract_kind': 'application_example',
            'transformation_text': 'Application example: Grob fragmentation of 5-bromo-2-(dimethylamino)pentane yields but-1-ene (and an iminium fragment).',
            'reactants_text': '5-bromo-2-(dimethylamino)pentane',
            'products_text': 'but-1-ene',
            'reagents_text': 'base',
            'conditions_text': 'curated application-class seed adding a longer-chain γ-amino-halide Grob example',
            'notes_text': 'Manual curated application-class seed added during the phase16 5+5 shallow-family completion sprint for Grob fragmentation. [phase16_shallow_top10_completion_v1]',
            'molecules': [
        ...
        # --- Hajos-Parrish Reaction ---
        {
            ...
            'extract_kind': 'application_example',
            'transformation_text': 'Application example: Hajos-Parrish reaction of 2-methyl-2-(3-oxobutyl)-1,3-cyclopentanedione with L-proline yields the Hajos-Parrish ketone.',
            'reactants_text': '2-methyl-2-(3-oxobutyl)-1,3-cyclopentanedione',
            'products_text': 'Hajos-Parrish ketone',
            'reagents_text': 'L-proline, DMF',
            'conditions_text': 'curated application-class seed representing the classical Hajos-Parrish enantioselective aldol',
            'notes_text': 'Manual curated application-class seed added during the phase16 5+5 shallow-family completion sprint for Hajos-Parrish reaction. [phase16_shallow_top10_completion_v1]',
            'molecules': [
                ('reactant', 'O=C1CC(=O)C1(C)CCC(C)=O', '2-methyl-2-(3-oxobutyl)-1,3-cyclopentanedione', 'reactants_text', 1),
                ('product', 'O=C1CCC2(C)C1CCC2=O', 'Hajos-Parrish ketone (net bicyclic framework)', 'products_text', 1),
            ],
        },
        {
            'family': 'Hajos-Parrish Reaction',
            'extract_kind': 'application_example',
            'transformation_text': 'Application example: Wieland-Miescher-style analog of the Hajos-Parrish reaction: 2-methyl-2-(3-oxobutyl)-1,3-cyclohexanedione with L-proline yields the Wieland-Miescher bicyclic framework.',
            'reactants_text': '2-methyl-2-(3-oxobutyl)-1,3-cyclohexanedione',
            'products_text': 'Wieland-Miescher framework',
            'reagents_text': 'L-proline, DMF',
            'conditions_text': 'curated application-class seed adding the six-membered Hajos-Parrish analog (Wieland-Miescher) example',
            'notes_text': 'Manual curated application-class seed added during the phase16 5+5 shallow-family completion sprint for Hajos-Parrish reaction. [phase16_shallow_top10_completion_v1]',
            'molecules': [

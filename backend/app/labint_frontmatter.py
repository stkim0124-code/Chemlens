...
def get_frontmatter_counts(db_path: str | Path, con: Optional[sqlite3.Connection] = None) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            "frontmatter_batch15_pages": q("SELECT COUNT(*) FROM manual_page_knowledge WHERE source_label = 'named_reactions_frontmatter_batch15'") if _table_exists(con, "manual_page_knowledge") else 0,
            "frontmatter_batch15_entities": q("SELECT COUNT(*) FROM manual_page_entities mpe JOIN manual_page_knowledge mpk ON mpe.page_knowledge_id = mpk.id WHERE mpk.source_label = 'named_reactions_frontmatter_batch15'") if _table_exists(con, "manual_page_entities") and _table_exists(con, "manual_page_knowledge") else 0,
            "frontmatter_batch16_pages": q("SELECT COUNT(*) FROM manual_page_knowledge WHERE source_label = 'named_reactions_frontmatter_batch16'") if _table_exists(con, "manual_page_knowledge") else 0,
            "frontmatter_batch16_entities": q("SELECT COUNT(*) FROM manual_page_entities mpe JOIN manual_page_knowledge mpk ON mpe.page_knowledge_id = mpk.id WHERE mpk.source_label = 'named_reactions_frontmatter_batch16'") if _table_exists(con, "manual_page_entities") and _table_exists(con, "manual_page_knowledge") else 0,
            "frontmatter_batch17_pages": q("SELECT COUNT(*) FROM manual_page_knowledge WHERE source_label = 'named_reactions_frontmatter_batch17'") if _table_exists(con, "manual_page_knowledge") else 0,
            "frontmatter_batch17_entities": q("SELECT COUNT(*) FROM manual_page_entities mpe JOIN manual_page_knowledge mpk ON mpe.page_knowledge_id = mpk.id WHERE mpk.source_label = 'named_reactions_frontmatter_batch17'") if _table_exists(con, "manual_page_entities") and _table_exists(con, "manual_page_knowledge") else 0,
            "frontmatter_batch18_pages": q("SELECT COUNT(*) FROM manual_page_knowledge WHERE source_label = 'named_reactions_frontmatter_batch18'") if _table_exists(con, "manual_page_knowledge") else 0,
            "frontmatter_batch18_entities": q("SELECT COUNT(*) FROM manual_page_entities mpe JOIN manual_page_knowledge mpk ON mpe.page_knowledge_id = mpk.id WHERE mpk.source_label = 'named_reactions_frontmatter_batch18'") if _table_exists(con, "manual_page_entities") and _table_exists(con, "manual_page_knowledge") else 0,
            "frontmatter_batch19_pages": q("SELECT COUNT(*) FROM manual_page_knowledge WHERE source_label = 'named_reactions_frontmatter_batch19'") if _table_exists(con, "manual_page_knowledge") else 0,
            "frontmatter_batch19_entities": q("SELECT COUNT(*) FROM manual_page_entities mpe JOIN manual_page_knowledge mpk ON mpe.page_knowledge_id = mpk.id WHERE mpk.source_label = 'named_reactions_frontmatter_batch19'") if _table_exists(con, "manual_page_entities") and _table_exists(con, "manual_page_knowledge") else 0,
            "frontmatter_batch20_pages": q("SELECT COUNT(*) FROM manual_page_knowledge WHERE source_label = 'named_reactions_frontmatter_batch20'") if _table_exists(con, "manual_page_knowledge") else 0,
            "frontmatter_batch20_entities": q("SELECT COUNT(*) FROM manual_page_entities mpe JOIN manual_page_knowledge mpk ON mpe.page_knowledge_id = mpk.id WHERE mpk.source_label = 'named_reactions_frontmatter_batch20'") if _table_exists(con, "manual_page_entities") and _table_exists(con, "manual_page_knowledge") else 0,
            "frontmatter_batch21_pages": q("SELECT COUNT(*) FROM manual_page_knowledge WHERE source_label = 'named_reactions_frontmatter_batch21'") if _table_exists(con, "manual_page_knowledge") else 0,
            "frontmatter_batch21_entities": q("SELECT COUNT(*) FROM manual_page_entities mpe JOIN manual_page_knowledge mpk ON mpe.page_knowledge_id = mpk.id WHERE mpk.source_label = 'named_reactions_frontmatter_batch21'") if _table_exists(con, "manual_page_entities") and _table_exists(con, "manual_page_knowledge") else 0,
            "frontmatter_batch22_pages": q("SELECT COUNT(*) FROM manual_page_knowledge WHERE source_label = 'named_reactions_frontmatter_batch22'") if _table_exists(con, "manual_page_knowledge") else 0,
            "frontmatter_batch22_entities": q("SELECT COUNT(*) FROM manual_page_entities mpe JOIN manual_page_knowledge mpk ON mpe.page_knowledge_id = mpk.id WHERE mpk.source_label = 'named_reactions_frontmatter_batch22'") if _table_exists(con, "manual_page_entities") and _table_exists(con, "manual_page_knowledge") else 0,
            "frontmatter_batch23_pages": q("SELECT COUNT(*) FROM manual_page_knowledge WHERE source_label = 'named_reactions_frontmatter_batch23'") if _table_exists(con, "manual_page_knowledge") else 0,
            "frontmatter_batch23_entities": q("SELECT COUNT(*) FROM manual_page_entities mpe JOIN manual_page_knowledge mpk ON mpe.page_knowledge_id = mpk.id WHERE mpk.source_label = 'named_reactions_frontmatter_batch23'") if _table_exists(con, "manual_page_entities") and _table_exists(con, "manual_page_knowledge") else 0,
            "frontmatter_batch24_pages": q("SELECT COUNT(*) FROM manual_page_knowledge WHERE source_label = 'named_reactions_frontmatter_batch24'") if _table_exists(con, "manual_page_knowledge") else 0,
            "frontmatter_batch24_entities": q("SELECT COUNT(*) FROM manual_page_entities mpe JOIN manual_page_knowledge mpk ON mpe.page_knowledge_id = mpk.id WHERE mpk.source_label = 'named_reactions_frontmatter_batch24'") if _table_exists(con, "manual_page_entities") and _table_exists(con, "manual_page_knowledge") else 0,
            "frontmatter_batch25_pages": q("SELECT COUNT(*) FROM manual_page_knowledge WHERE source_label = 'named_reactions_frontmatter_batch25'") if _table_exists(con, "manual_page_knowledge") else 0,
            "frontmatter_batch25_entities": q("SELECT COUNT(*) FROM manual_page_entities mpe JOIN manual_page_knowledge mpk ON mpe.page_knowledge_id = mpk.id WHERE mpk.source_label = 'named_reactions_frontmatter_batch25'") if _table_exists(con, "manual_page_entities") and _table_exists(con, "manual_page_knowledge") else 0,
            "frontmatter_batch26_pages": q("SELECT COUNT(*) FROM manual_page_knowledge WHERE source_label = 'named_reactions_frontmatter_batch26'") if _table_exists(con, "manual_page_knowledge") else 0,
            "frontmatter_batch26_entities": q("SELECT COUNT(*) FROM manual_page_entities mpe JOIN manual_page_knowledge mpk ON mpe.page_knowledge_id = mpk.id WHERE mpk.source_label = 'named_reactions_frontmatter_batch26'") if _table_exists(con, "manual_page_entities") and _table_exists(con, "manual_page_knowledge") else 0,
        }
    finally:
        if close_after:
            con.close()

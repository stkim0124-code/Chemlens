...
ALIAS_RESIDUES = {'Charette Asymmetric Cyclopropanation': ['Charette Cyclopropanation'], 'Chugaev Elimination Reaction (Xanthate Ester Pyrolysis)': ['Chugaev Elimination', 'Chugaev Elimination Reaction'], 'Combes Quinoline Synthesis': ['Combes Reaction'], 'Curtius Rearrangement': [], 'Dakin Oxidation': ['Dakin Oxidation / Dakin Reaction']}

TAG = 'phase7_shallow_top5_completion_'
...
def main() -> int:
    ...
    ap.add_argument('--report-dir', default='reports/family_completion_phase7_shallow_top5_verify')
    args = ap.parse_args()
    ...
    try:
        ...
        jpath = report_dir / 'family_completion_phase7_shallow_top5_verify.json'
        mpath = report_dir / 'family_completion_phase7_shallow_top5_verify.md'

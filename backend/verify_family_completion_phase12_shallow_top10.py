...
ALIAS_RESIDUES = {'Feist-Bénary Furan Synthesis': ['Feist-Benary Furan Synthesis'], 'Fischer Indole Synthesis': ['Fischer Indole Reaction'], 'Fleming-Tamao Oxidation': ['Fleming Tamao Oxidation'], 'Friedel-Crafts Acylation': ['Friedel Crafts Acylation'], 'Friedel-Crafts Alkylation': ['Friedel Crafts Alkylation'], 'Finkelstein Reaction': [], 'Gabriel Synthesis': ['Gabriel Reaction'], 'Favorskii Rearrangement': ['Favorskii Reaction'], 'Ferrier Reaction': ['Ferrier Reaction/Rearrangement'], 'Evans Aldol Reaction': ['Evans Aldol']}

TAG = 'phase12_shallow_top10_completion_'
...
def main() -> int:
    ap = argparse.ArgumentParser(description='Verify shallow-family sprint phase12 top10 in 5+5 batches.')
    ap.add_argument('--db', default='app/labint.db')
    ap.add_argument('--report-dir', default='reports/family_completion_phase12_shallow_top10_verify')

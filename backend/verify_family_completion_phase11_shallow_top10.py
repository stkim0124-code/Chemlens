...
ALIAS_RESIDUES = {
    "Danishefsky's Diene Cycloaddition": ['Danishefsky Diene Cycloaddition'],
    'De Mayo Cycloaddition': ['De Mayo Cycloaddition (Enone-Alkene [2+2] Photocycloaddition)'],
    'Demjanov Rearrangement and Tiffeneau-Demjanov Rearrangement': ['Demjanov and Tiffeneau-Demjanov Rearrangement'],
    'Dess-Martin Oxidation': ['Dess-Martin Reaction'],
    'Dieckmann Condensation': [],
    'Diels-Alder Cycloaddition': [],
    'Dienone-Phenol Rearrangement': [],
    'Enyne Metathesis': ['Enyne Ring-Closing Metathesis'],
    'Eschenmoser-Claisen Rearrangement': ['Eschenmoser Claisen Rearrangement'],
    'Eschweiler-Clarke Methylation': ['Eschweiler-Clarke Methylation (Reductive Alkylation)'],
}

TAG = 'phase11_shallow_top10_completion_'
...
def main() -> int:
    ap = argparse.ArgumentParser(description='Verify shallow-family sprint phase11 top10 in 5+5 batches.')
    ap.add_argument('--db', default='app/labint.db')
    ap.add_argument('--report-dir', default='reports/family_completion_phase11_shallow_top10_verify')

...
ALIAS_RESIDUES = {'Knoevenagel Condensation': [], 'Knorr Pyrrole Synthesis': [], 'Kornblum Oxidation': [], 'Krapcho Dealkoxycarbonylation (Krapcho Reaction)': ['Krapcho Dealkoxycarbonylation'], 'Kumada Cross-Coupling': ['Kumada Coupling', 'Kumada Cross Coupling'], 'Ley Oxidation': ['Ley Oxidation of Alcohols'], 'Lieben Haloform Reaction': ['Haloform Reaction'], 'Lossen Rearrangement': [], 'Luche Reduction': ['Luche Reaction'], 'Mannich Reaction': []}
TAG = 'phase15_shallow_top10_completion_'
...
def main() -> int:
    ap=argparse.ArgumentParser(description='Verify shallow-family sprint phase15 top10 in 5+5 batches.')
    ap.add_argument('--db', default='app/labint.db')
    ap.add_argument('--report-dir', default='reports/family_completion_phase15_shallow_top10_verify')

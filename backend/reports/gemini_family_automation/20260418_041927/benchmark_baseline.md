...
|---|---|:---:|---|---:|:---:|
| noisy_acetic_acid | `Acetic acid` | ❌ | Aldol Reaction | 0.547 | ❌ |
| noisy_ethanol | `Ethanol` | ❌ | Birch Reduction | 0.84 | ❌ |
| noisy_benzene | `Benzene` | ❌ | Buchner Reaction | 0.605 | ❌ |
| noisy_acetone | `Acetone` | ❌ | Aldol Reaction | 0.781 | ❌ |
...
| benzilic_402_exact_extract | Benzilic Acid Rearrangement | Aldol Reaction | Aldol Reaction, Claisen-Ireland Rearrangement, Cannizzaro Reaction | 탈산소화 | 2 | yes |

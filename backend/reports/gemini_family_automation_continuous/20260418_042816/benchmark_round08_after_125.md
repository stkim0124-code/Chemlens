...
|---|---|:---:|---|---:|:---:|
| noisy_acetic_acid | `Acetic acid` | ❌ | Eschenmoser-Tanabe Fragmentation | 0.84 | ❌ |
| noisy_ethanol | `Ethanol` | ❌ | Birch Reduction | 0.84 | ❌ |
| noisy_benzene | `Benzene` | ❌ | Buchner Reaction | 0.605 | ❌ |
| noisy_acetone | `Acetone` | ❌ | Eschenmoser-Tanabe Fragmentation | 0.525 | ❌ |
...
| meaningful_cyclohexanone | Baeyer-Villiger Oxidation | Eschenmoser Methenylation | Eschenmoser Methenylation | 1.942 | ❌ |
| meaningful_aniline_aryl_bromide | Buchwald-Hartwig Cross-Coupling | Buchwald-Hartwig Cross-Coupling | Buchwald-Hartwig Cross-Coupling, Arbuzov Reaction (Michaelis-Arbuzov Reaction) | 0.419 | 0.125 | ✅ |
...
| bv_341_exact_extract | Baeyer-Villiger Oxidation | Baeyer-Villiger Oxidation | Baeyer-Villiger Oxidation, Clemmensen Reduction, Birch Reduction | 탈산소화, 탈카복실화 | 4 |  |
...
| buchner_403_exact_extract | Buchner Reaction | Buchner Reaction | Buchner Reaction, Arbuzov Reaction (Michaelis-Arbuzov Reaction), Acetoacetic Ester Synthesis |  | 2 |  |

...
|---|---|:---:|---|---:|:---:|
| noisy_acetic_acid | `Acetic acid` | ❌ | Dakin-West Reaction | 0.883 | ❌ |
| noisy_ethanol | `Ethanol` | ❌ | Johnson-Claisen Rearrangement | 0.49 | ❌ |
| noisy_benzene | `Benzene` | ❌ | Friedel-Crafts Alkylation | 0.84 | ❌ |
| noisy_acetone | `Acetone` | ❌ | Dakin-West Reaction | 0.869 | ❌ |
| noisy_toluene | `Toluene` | ❌ | Gattermann and Gattermann-Koch Formylation | 1.62 | ❌ |
...
|---|---|---|---|---|:---:|
| meaningful_pentanoic_acid | Barton Radical Decarboxylation Reaction | Barton Radical Decarboxylation Reaction | Barton Radical Decarboxylation Reaction, Barton-Mccombie Radical Deoxygenation Reaction, Corey-Nicolaou Macrolactonization | 0.891 | 0.283 | 0.229 | ✅ |
| meaningful_cyclohexanone | Baeyer-Villiger Oxidation | Eschenmoser-Tanabe Fragmentation | Eschenmoser-Tanabe Fragmentation, Corey-Nicolaou Macrolactonization, Baeyer-Villiger Oxidation/Rearrangement | 0.733 | 0.48 | 0.454 | ✅ |
| meaningful_aniline_aryl_bromide | Buchwald-Hartwig Cross-Coupling | Buchwald-Hartwig Cross-Coupling | Buchwald-Hartwig Cross-Coupling, Combes Quinoline Synthesis, Hofmann Rearrangement | 0.419 | 0.177 | 0.177 | ✅ |
...
|---|---|---|---|---|---:|---|
| bv_340_exact_extract | Baeyer-Villiger Oxidation | Baeyer-Villiger Oxidation | Baeyer-Villiger Oxidation, Dess-Martin Oxidation, Clemmensen Reduction | 산화, 탈카복실화, ester/lactone 삽입형 산화 | 2 |  |
| bv_341_exact_extract | Baeyer-Villiger Oxidation | Baeyer-Villiger Oxidation | Baeyer-Villiger Oxidation, Dess-Martin Oxidation, Clemmensen Reduction | 탈산소화, 탈카복실화 | 5 |  |
...
| bh_370_exact_extract | Buchwald-Hartwig Cross-Coupling | Buchwald-Hartwig Cross-Coupling | Buchwald-Hartwig Cross-Coupling, Danishefsky's Diene Cycloaddition, Heine Reaction | 커플링, 당/다가산소 재배열 | 0 |  |
...
| buchner_403_exact_extract | Buchner Reaction | Buchner Reaction | Buchner Reaction, Johnson-Claisen Rearrangement, Acetoacetic Ester Synthesis |  | 2 |  |
...
| baker_344_exact_extract | Baker-Venkataraman Rearrangement | Baker-Venkataraman Rearrangement | Baker-Venkataraman Rearrangement, Hofmann Rearrangement, Clemmensen Reduction | 산화 | 0 |  |
| balz_351_exact_extract | Balz-Schiemann Reaction | Balz-Schiemann Reaction | Balz-Schiemann Reaction |  | 0 |  |
| bartoli_413_exact_extract | Bartoli Indole Synthesis | Bartoli Indole Synthesis | Bartoli Indole Synthesis, Dakin Oxidation | 산화 | 0 |  |
...
| chichibabin_386_exact_extract | Chichibabin Amination Reaction | Chichibabin Amination Reaction | Chichibabin Amination Reaction, Friedel-Crafts Alkylation |  | 0 |  |
| claisen_cond_408_exact_extract | Claisen Condensation | Claisen Condensation | Claisen Condensation, Acetoacetic Ester Synthesis, Knorr Pyrrole Synthesis | 산화, ester/lactone 삽입형 산화 | 1 |  |
...
| bv_342_exact_extract | Baeyer-Villiger Oxidation | Baeyer-Villiger Oxidation | Baeyer-Villiger Oxidation, Bamford-Stevens-Shapiro Olefination, Gattermann and Gattermann-Koch Formylation | 탈산소화, 탈카복실화 | 6 |  |
...
| benzilic_402_exact_extract | Benzilic Acid Rearrangement | Claisen-Ireland Rearrangement | Claisen-Ireland Rearrangement, Dakin Oxidation, Cannizzaro Reaction | 탈산소화 | 2 | yes |

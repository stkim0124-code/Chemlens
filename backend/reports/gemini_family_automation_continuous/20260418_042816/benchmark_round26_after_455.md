...
| meaningful_cyclohexanone | Baeyer-Villiger Oxidation | Corey-Nicolaou Macrolactonization | Corey-Nicolaou Macrolactonization, Baeyer-Villiger Oxidation/Rearrangement, Corey-Kim Oxidation | 0.48 | 0.454 | 0.316 | ✅ |
...
|---|---|---|---|---|---:|---|
| bv_340_exact_extract | Baeyer-Villiger Oxidation | Baeyer-Villiger Oxidation | Baeyer-Villiger Oxidation, Clemmensen Reduction, Arbuzov Reaction (Michaelis-Arbuzov Reaction) | 산화, 탈카복실화, ester/lactone 삽입형 산화 | 2 |  |
| bv_341_exact_extract | Baeyer-Villiger Oxidation | Baeyer-Villiger Oxidation | Baeyer-Villiger Oxidation, Clemmensen Reduction, Arbuzov Reaction (Michaelis-Arbuzov Reaction) | 탈산소화, 탈카복실화 | 5 |  |

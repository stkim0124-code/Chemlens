...
generated_at: 2026-04-20 21:29:40
...
- registry_family_distinct_total_canonicalized: 267
- families_with_extracts_canonicalized: 267
- queryable_family_count_canonicalized: 260
- reaction_extract_count: 659
- extract_molecule_count: 3113
- queryable_molecule_count: 1285
- extracts_with_both_smiles: 396
...
- Dimroth Rearrangement :: extract_count=1, overview=1, application=0, pairs=1
- Doering-Laflamme Allene Synthesis :: extract_count=1, overview=1, application=0, pairs=1
- Dötz Benzannulation Reaction :: extract_count=1, overview=1, application=0, pairs=1
- Enders SAMP/RAMP Hydrazone Alkylation :: extract_count=1, overview=1, application=0, pairs=1
- Eschenmoser Methenylation :: extract_count=1, overview=1, application=0, pairs=1
- Eschenmoser-Tanabe Fragmentation :: extract_count=1, overview=1, application=0, pairs=1
- Favorskii and Homo-Favorskii Rearrangement :: extract_count=1, overview=1, application=0, pairs=1
- Furukawa Modification :: extract_count=1, overview=1, application=0, pairs=1
- Gattermann and Gattermann-Koch Formylation :: extract_count=1, overview=1, application=0, pairs=1
- Grob Fragmentation :: extract_count=1, overview=1, application=0, pairs=1
- Hajos-Parrish Reaction :: extract_count=1, overview=1, application=0, pairs=1
- Heine Reaction :: extract_count=1, overview=1, application=0, pairs=1
- Horner-Wadsworth-Emmons Olefination – Still-Gennari Modification :: extract_count=1, overview=1, application=0, pairs=1
- Hunsdiecker Reaction :: extract_count=1, overview=1, application=0, pairs=1
- Intramolecular Nitrile Oxide Cycloaddition :: extract_count=1, overview=1, application=0, pairs=1
- Jacobsen Hydrolytic Kinetic Resolution :: extract_count=1, overview=1, application=0, pairs=1
- Jacobsen-Katsuki Epoxidation :: extract_count=1, overview=1, application=0, pairs=1
- Japp-Klingemann Reaction :: extract_count=1, overview=1, application=0, pairs=1
- Johnson-Claisen Rearrangement :: extract_count=1, overview=1, application=0, pairs=1
- Jones Oxidation :: extract_count=1, overview=1, application=0, pairs=1
- Jones Oxidation/Oxidation of Alcohols by Chromium Reagents :: extract_count=1, overview=1, application=0, pairs=1
- Julia-Lythgoe Olefination :: extract_count=1, overview=1, application=0, pairs=1
- Kagan-Molander Samarium Diiodide-Mediated Coupling :: extract_count=1, overview=1, application=0, pairs=1
- Kahne Glycosidation :: extract_count=1, overview=1, application=0, pairs=1

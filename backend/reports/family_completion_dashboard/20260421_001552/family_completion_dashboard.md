...
generated_at: 2026-04-21 00:15:52
source_verifier_json: C:\chemlens\backend\reports\final_state_verifier\20260421_001551\final_state_verifier.json
...
- reaction_extract_count: 1151
- extract_molecule_count: 4101
- queryable_molecule_count: 2273
- extracts_with_both_smiles: 890

## Completion bucket counts
- missing_count_canonicalized: 0
- shallow_count_canonicalized: 30
- rich_count_canonicalized: 234
- collision_prone_candidate_count_canonicalized: 20
...
- Alkyne Metathesis :: extract_count=4, overview=0, application=3, pairs=0
- Beckmann Rearrangement :: extract_count=4, overview=0, application=3, pairs=0
- Bergman Cycloaromatization Reaction :: extract_count=4, overview=1, application=1, pairs=0
- Biginelli Reaction :: extract_count=4, overview=2, application=0, pairs=0
- Brown Hydroboration Reaction :: extract_count=4, overview=1, application=0, pairs=0
- Aza-Cope Rearrangement :: extract_count=4, overview=0, application=3, pairs=1
- Barton Radical Decarboxylation Reaction :: extract_count=4, overview=1, application=1, pairs=1
- Brook Rearrangement :: extract_count=4, overview=0, application=3, pairs=2
- Claisen Rearrangement :: extract_count=4, overview=3, application=0, pairs=2
- Aza-[2,3]-Wittig Rearrangement :: extract_count=5, overview=1, application=3, pairs=0
- Bischler-Napieralski Isoquinoline Synthesis :: extract_count=5, overview=0, application=4, pairs=1
- Cannizzaro Reaction :: extract_count=5, overview=2, application=1, pairs=1
- Baeyer-Villiger Oxidation :: extract_count=5, overview=5, application=0, pairs=3
- Baker-Venkataraman Rearrangement :: extract_count=5, overview=0, application=4, pairs=3
- Barton Radical Decarboxylation :: extract_count=5, overview=0, application=5, pairs=5
- Bartoli Indole Synthesis :: extract_count=6, overview=0, application=5, pairs=1
- Claisen-Ireland Rearrangement :: extract_count=7, overview=2, application=3, pairs=0
- Arndt-Eistert Homologation / Synthesis :: extract_count=7, overview=0, application=6, pairs=1
- Burgess Dehydration Reaction :: extract_count=9, overview=5, application=3, pairs=0
- Benzoin and Retro-Benzoin Condensation :: extract_count=11, overview=0, application=10, pairs=1
- Corey-Kim Oxidation :: extract_count=3, overview=1, application=2, pairs=2
- Darzens Glycidic Ester Condensation :: extract_count=3, overview=1, application=2, pairs=2
- Friedel-Crafts Acylation :: extract_count=3, overview=1, application=2, pairs=2
- Friedel-Crafts Alkylation :: extract_count=3, overview=1, application=2, pairs=2
- Barton Nitrite Ester Reaction :: extract_count=6, overview=2, application=2, pairs=1

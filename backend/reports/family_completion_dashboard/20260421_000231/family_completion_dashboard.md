...
generated_at: 2026-04-21 00:02:31
source_verifier_json: C:\chemlens\backend\reports\final_state_verifier\20260421_000229\final_state_verifier.json
...
- reaction_extract_count: 971
- extract_molecule_count: 3741
- queryable_molecule_count: 1913
- extracts_with_both_smiles: 708

## Completion bucket counts
- missing_count_canonicalized: 0
- shallow_count_canonicalized: 89
- rich_count_canonicalized: 175
...
- Schmidt Reaction :: extract_count=1, overview=1, application=0, pairs=1
- Schotten-Baumann Reaction :: extract_count=1, overview=1, application=0, pairs=1
- Schwartz Hydrozirconation :: extract_count=1, overview=1, application=0, pairs=1
- Seyferth-Gilbert Homologation :: extract_count=1, overview=1, application=0, pairs=1
- Sharpless Asymmetric Aminohydroxylation :: extract_count=1, overview=1, application=0, pairs=1
- Sharpless Asymmetric Dihydroxylation :: extract_count=1, overview=1, application=0, pairs=1
- Sharpless Asymmetric Epoxidation :: extract_count=1, overview=1, application=0, pairs=1
- Shi Asymmetric Epoxidation :: extract_count=1, overview=1, application=0, pairs=1
- Simmons-Smith Cyclopropanation :: extract_count=1, overview=1, application=0, pairs=1
- Simmons-Smith Reaction :: extract_count=1, overview=1, application=0, pairs=1

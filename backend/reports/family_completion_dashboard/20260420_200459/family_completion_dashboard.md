...
generated_at: 2026-04-20 20:04:59
source_verifier_json: reports\final_state_verifier\20260420_200456\final_state_verifier.json

## Summary
- registry_family_total_raw: 305
- registry_family_distinct_total_raw: 291
- registry_duplicate_name_rows_raw: 14
- registry_family_distinct_total_canonicalized: 273
- families_with_extracts_canonicalized: 273
- queryable_family_count_canonicalized: 266
- reaction_extract_count: 596
- extract_molecule_count: 2957
- queryable_molecule_count: 1129
- extracts_with_both_smiles: 333

## Completion bucket counts
- missing_count_canonicalized: 0
- shallow_count_canonicalized: 236
- rich_count_canonicalized: 37
- collision_prone_candidate_count_canonicalized: 23
- recent_completed_family_count_canonicalized: 32
- missing_count_raw_uncollapsed: 17
...
- Danishefsky's Diene Cycloaddition :: extract_count=1, overview=1, application=0, pairs=1
- De Mayo Cycloaddition :: extract_count=1, overview=1, application=0, pairs=1
- De Mayo Cycloaddition (Enone-Alkene [2+2] Photocycloaddition) :: extract_count=1, overview=1, application=0, pairs=1
- Demjanov Rearrangement and Tiffeneau-Demjanov Rearrangement :: extract_count=1, overview=1, application=0, pairs=1
- Demjanov and Tiffeneau-Demjanov Rearrangement :: extract_count=1, overview=1, application=0, pairs=1
- Dess-Martin Oxidation :: extract_count=1, overview=1, application=0, pairs=1
- Dieckmann Condensation :: extract_count=1, overview=1, application=0, pairs=1
- Diels-Alder Cycloaddition :: extract_count=1, overview=1, application=0, pairs=1
- Dienone-Phenol Rearrangement :: extract_count=1, overview=1, application=0, pairs=1
...
- Enyne Metathesis :: extract_count=1, overview=1, application=0, pairs=1
- Eschenmoser Methenylation :: extract_count=1, overview=1, application=0, pairs=1
- Eschenmoser-Claisen Rearrangement :: extract_count=1, overview=1, application=0, pairs=1
- Eschenmoser-Tanabe Fragmentation :: extract_count=1, overview=1, application=0, pairs=1
- Eschweiler-Clarke Methylation :: extract_count=1, overview=1, application=0, pairs=1
- Eschweiler-Clarke Methylation (Reductive Alkylation) :: extract_count=1, overview=1, application=0, pairs=1
- Evans Aldol Reaction :: extract_count=1, overview=1, application=0, pairs=1
- Favorskii Rearrangement :: extract_count=1, overview=1, application=0, pairs=1
- Favorskii and Homo-Favorskii Rearrangement :: extract_count=1, overview=1, application=0, pairs=1
- Feist-Bénary Furan Synthesis :: extract_count=1, overview=1, application=0, pairs=1
- Ferrier Reaction :: extract_count=1, overview=1, application=0, pairs=1

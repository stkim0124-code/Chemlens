...
generated_at: 2026-04-21 00:03:55
source_verifier_json: C:\chemlens\backend\reports\final_state_verifier\20260421_000353\final_state_verifier.json
...
- reaction_extract_count: 1001
- extract_molecule_count: 3801
- queryable_molecule_count: 1973
- extracts_with_both_smiles: 738

## Completion bucket counts
- missing_count_canonicalized: 0
- shallow_count_canonicalized: 79
- rich_count_canonicalized: 185
...
- Skraup and Doebner-Miller Quinoline Synthesis :: extract_count=1, overview=1, application=0, pairs=1
- Smiles Rearrangement :: extract_count=1, overview=1, application=0, pairs=1
- Smith-Tietze Multicomponent Dithiane Linchpin Coupling :: extract_count=1, overview=1, application=0, pairs=1
- Snieckus Directed Ortho Metalation :: extract_count=1, overview=1, application=0, pairs=1
- Sommelet-Hauser Rearrangement :: extract_count=1, overview=1, application=0, pairs=1
- Sonogashira Cross-Coupling :: extract_count=1, overview=1, application=0, pairs=1
- Staudinger Ketene Cycloaddition :: extract_count=1, overview=1, application=0, pairs=1
- Staudinger Reaction :: extract_count=1, overview=1, application=0, pairs=1
- Stephen Aldehyde Synthesis (Stephen Reduction) :: extract_count=1, overview=1, application=0, pairs=1
- Stetter Reaction :: extract_count=1, overview=1, application=0, pairs=1

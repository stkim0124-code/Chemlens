...
generated_at: 2026-04-21 00:07:44
source_verifier_json: C:\chemlens\backend\reports\final_state_verifier\20260421_000743\final_state_verifier.json
...
- reaction_extract_count: 1061
- extract_molecule_count: 3921
- queryable_molecule_count: 2093
- extracts_with_both_smiles: 798

## Completion bucket counts
- missing_count_canonicalized: 0
- shallow_count_canonicalized: 59
- rich_count_canonicalized: 205
...
- Williamson Ether Synthesis :: extract_count=1, overview=1, application=0, pairs=1
- Wittig Reaction :: extract_count=1, overview=1, application=0, pairs=1
- Wittig Reaction - Schlosser Modification :: extract_count=1, overview=1, application=0, pairs=1
- Wittig-[1,2]- and [2,3]-Rearrangement :: extract_count=1, overview=1, application=0, pairs=1
- Wohl-Ziegler Bromination :: extract_count=1, overview=1, application=0, pairs=1
- Wolff Rearrangement :: extract_count=1, overview=1, application=0, pairs=1
- Wolff-Kishner Reduction :: extract_count=1, overview=1, application=0, pairs=1
- Wurtz Coupling :: extract_count=1, overview=1, application=0, pairs=1
- Yamaguchi Macrolactonization :: extract_count=1, overview=1, application=0, pairs=1
- von Pechmann Reaction :: extract_count=1, overview=1, application=0, pairs=1

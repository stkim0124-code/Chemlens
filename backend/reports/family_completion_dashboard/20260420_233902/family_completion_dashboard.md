...
generated_at: 2026-04-20 23:39:02
source_verifier_json: C:\chemlens\backend\reports\final_state_verifier\20260420_233901\final_state_verifier.json
...
- reaction_extract_count: 731
- extract_molecule_count: 3261
- queryable_molecule_count: 1433
- extracts_with_both_smiles: 468

## Completion bucket counts
- missing_count_canonicalized: 0
- shallow_count_canonicalized: 169
- rich_count_canonicalized: 95
...
- Kulinkovich Reaction :: extract_count=1, overview=1, application=0, pairs=1
- Kulinovich Reaction :: extract_count=1, overview=1, application=0, pairs=1
- Larock Indole Synthesis :: extract_count=1, overview=1, application=0, pairs=1
- Madelung Indole Synthesis :: extract_count=1, overview=1, application=0, pairs=1
- Malonic Ester Synthesis :: extract_count=1, overview=1, application=0, pairs=1
- McMurry Coupling :: extract_count=1, overview=1, application=0, pairs=1
- Meerwein Arylation :: extract_count=1, overview=1, application=0, pairs=1
- Meerwein-Ponndorf-Verley Reduction :: extract_count=1, overview=1, application=0, pairs=1
- Meisenheimer Rearrangement :: extract_count=1, overview=1, application=0, pairs=1
- Meyer-Schuster and Rupe Rearrangement :: extract_count=1, overview=1, application=0, pairs=1
- Michael Addition Reaction :: extract_count=1, overview=1, application=0, pairs=1
- Midland Alpine Borane Reduction :: extract_count=1, overview=1, application=0, pairs=1
- Minisci Reaction :: extract_count=1, overview=1, application=0, pairs=1
- Mislow-Evans Rearrangement :: extract_count=1, overview=1, application=0, pairs=1
- Mitsunobu Reaction :: extract_count=1, overview=1, application=0, pairs=1

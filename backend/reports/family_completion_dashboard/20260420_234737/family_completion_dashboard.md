...
generated_at: 2026-04-20 23:47:37
source_verifier_json: C:\chemlens\backend\reports\final_state_verifier\20260420_234736\final_state_verifier.json
...
- reaction_extract_count: 761
- extract_molecule_count: 3321
- queryable_molecule_count: 1493
- extracts_with_both_smiles: 498

## Completion bucket counts
- missing_count_canonicalized: 0
- shallow_count_canonicalized: 159
- rich_count_canonicalized: 105
...
- Miyaura Boration :: extract_count=1, overview=1, application=0, pairs=1
- Mukaiyama Aldol Reaction :: extract_count=1, overview=1, application=0, pairs=1
- Myers Asymmetric Alkylation :: extract_count=1, overview=1, application=0, pairs=1
- Nagata Hydrocyanation :: extract_count=1, overview=1, application=0, pairs=1
- Nazarov Cyclization :: extract_count=1, overview=1, application=0, pairs=1
- Neber Rearrangement :: extract_count=1, overview=1, application=0, pairs=1
- Nef Reaction :: extract_count=1, overview=1, application=0, pairs=1
- Negishi Cross-Coupling :: extract_count=1, overview=1, application=0, pairs=1
- Nenitzescu Indole Synthesis :: extract_count=1, overview=1, application=0, pairs=1
- Nicholas Reaction :: extract_count=1, overview=1, application=0, pairs=1

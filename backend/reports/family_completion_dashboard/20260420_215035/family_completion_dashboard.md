...
generated_at: 2026-04-20 21:50:35
source_verifier_json: reports\final_state_verifier\20260420_215032\final_state_verifier.json

## Summary
- registry_family_total_raw: 305
- registry_family_distinct_total_raw: 291
- registry_duplicate_name_rows_raw: 14
- registry_family_distinct_total_canonicalized: 265
- families_with_extracts_canonicalized: 265
- queryable_family_count_canonicalized: 258
- reaction_extract_count: 679
- extract_molecule_count: 3155
- queryable_molecule_count: 1327
- extracts_with_both_smiles: 416

## Completion bucket counts
- missing_count_canonicalized: 0
- shallow_count_canonicalized: 190
- rich_count_canonicalized: 75
- collision_prone_candidate_count_canonicalized: 23
- recent_completed_family_count_canonicalized: 72
- missing_count_raw_uncollapsed: 25
...
- Keck Asymmetric Allylation :: extract_count=1, overview=1, application=0, pairs=1
- Keck Macrolactonization :: extract_count=1, overview=1, application=0, pairs=1
- Keck Radical Allylation :: extract_count=1, overview=1, application=0, pairs=1
- Knoevenagel Condensation :: extract_count=1, overview=1, application=0, pairs=1
- Knorr Pyrrole Synthesis :: extract_count=1, overview=1, application=0, pairs=1
- Koenigs-Knorr Glycosidation :: extract_count=1, overview=1, application=0, pairs=1
- Kolbe-Schmitt Reaction :: extract_count=1, overview=1, application=0, pairs=1
- Kornblum Oxidation :: extract_count=1, overview=1, application=0, pairs=1
- Krapcho Dealkoxycarbonylation :: extract_count=1, overview=1, application=0, pairs=1
- Krapcho Dealkoxycarbonylation (Krapcho Reaction) :: extract_count=1, overview=1, application=0, pairs=1
- Kröhnke Pyridine Synthesis :: extract_count=1, overview=1, application=0, pairs=1

...
generated_at: 2026-04-21 00:00:29
source_verifier_json: C:\chemlens\backend\reports\final_state_verifier\20260421_000028\final_state_verifier.json
...
- reaction_extract_count: 941
- extract_molecule_count: 3681
- queryable_molecule_count: 1853
- extracts_with_both_smiles: 678

## Completion bucket counts
- missing_count_canonicalized: 0
- shallow_count_canonicalized: 99
- rich_count_canonicalized: 165
...
- Ring-Closing Metathesis :: extract_count=1, overview=1, application=0, pairs=1
- Ring-Opening Metathesis :: extract_count=1, overview=1, application=0, pairs=1
- Ring-Opening Metathesis Polymerization :: extract_count=1, overview=1, application=0, pairs=1
- Ritter Reaction :: extract_count=1, overview=1, application=0, pairs=1
- Robinson Annulation :: extract_count=1, overview=1, application=0, pairs=1
- Roush Asymmetric Allylation :: extract_count=1, overview=1, application=0, pairs=1
- Rubottom Oxidation :: extract_count=1, overview=1, application=0, pairs=1
- Saegusa Oxidation :: extract_count=1, overview=1, application=0, pairs=1
- Sakurai Allylation :: extract_count=1, overview=1, application=0, pairs=1
- Sandmeyer Reaction :: extract_count=1, overview=1, application=0, pairs=1

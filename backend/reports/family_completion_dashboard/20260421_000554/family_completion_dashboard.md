...
generated_at: 2026-04-21 00:05:54
source_verifier_json: C:\chemlens\backend\reports\final_state_verifier\20260421_000553\final_state_verifier.json
...
- reaction_extract_count: 1031
- extract_molecule_count: 3861
- queryable_molecule_count: 2033
- extracts_with_both_smiles: 768

## Completion bucket counts
- missing_count_canonicalized: 0
- shallow_count_canonicalized: 69
- rich_count_canonicalized: 195
- collision_prone_candidate_count_canonicalized: 23
- recent_completed_family_count_canonicalized: 82
- missing_count_raw_uncollapsed: 26
...
- Stevens Rearrangement :: extract_count=1, overview=1, application=0, pairs=1
- Stille Carbonylative Cross-Coupling :: extract_count=1, overview=1, application=0, pairs=1
- Stille Cross-Coupling (Migita-Kosugi-Stille Coupling) :: extract_count=1, overview=1, application=0, pairs=1
- Stille-Kelly Coupling :: extract_count=1, overview=1, application=0, pairs=1
- Stobbe Condensation :: extract_count=1, overview=1, application=0, pairs=1
- Stork Enamine Synthesis :: extract_count=1, overview=1, application=0, pairs=1
- Strecker Reaction :: extract_count=1, overview=1, application=0, pairs=1
- Suzuki Cross-Coupling :: extract_count=1, overview=1, application=0, pairs=1
- Suzuki Cross-Coupling (Suzuki-Miyaura Cross-Coupling) :: extract_count=1, overview=1, application=0, pairs=1
- Swern Oxidation :: extract_count=1, overview=1, application=0, pairs=1
- Takai-Utimoto Olefination (Takai Reaction) :: extract_count=1, overview=1, application=0, pairs=1
- Tebbe Olefination/Petasis-Tebbe Olefination :: extract_count=1, overview=1, application=0, pairs=1
- Tishchenko Reaction :: extract_count=1, overview=1, application=0, pairs=1
- Tsuji-Trost Reaction / Allylation :: extract_count=1, overview=1, application=0, pairs=1
- Tsuji-Wilkinson Decarbonylation Reaction :: extract_count=1, overview=1, application=0, pairs=1
- Ugi Multicomponent Reaction :: extract_count=1, overview=1, application=0, pairs=1
- Ullmann Biaryl Ether and Biaryl Amine Synthesis / Condensation :: extract_count=1, overview=1, application=0, pairs=1
- Ullmann Reaction / Coupling / Biaryl Synthesis :: extract_count=1, overview=1, application=0, pairs=1
- Vilsmeier-Haack Formylation :: extract_count=1, overview=1, application=0, pairs=1
- Vinylcyclopropane-Cyclopentene Rearrangement :: extract_count=1, overview=1, application=0, pairs=1
- Wacker Oxidation :: extract_count=1, overview=1, application=0, pairs=1
- Wagner-Meerwein Rearrangement :: extract_count=1, overview=1, application=0, pairs=1
- Weinreb Ketone Synthesis :: extract_count=1, overview=1, application=0, pairs=1
- Wharton Fragmentation :: extract_count=1, overview=1, application=0, pairs=1
- Wharton Olefin Synthesis (Wharton Transposition) :: extract_count=1, overview=1, application=0, pairs=1

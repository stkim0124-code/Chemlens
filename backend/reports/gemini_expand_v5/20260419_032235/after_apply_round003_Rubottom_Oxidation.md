...
|---|---|:---:|---|---:|:---:|
| noisy_acetic_acid | `Acetic acid` | ❌ | Peterson Olefination | 0.777 | ❌ |
| noisy_ethanol | `Ethanol` | ❌ | Fleming-Tamao Oxidation | 1.069 | ❌ |
| noisy_benzene | `Benzene` | ❌ | Friedel-Crafts Acylation | 0.84 | ❌ |
| noisy_acetone | `Acetone` | ❌ | Peterson Olefination | 1.12 | ❌ |
...
| meaningful_aniline_aryl_bromide | Buchwald-Hartwig Cross-Coupling | Kumada Cross-Coupling | Kumada Cross-Coupling, Negishi Cross-Coupling, Buchwald-Hartwig Cross-Coupling | 0.486 | 0.457 | 0.419 | ✅ |
...
| brook_416_exact_extract | Brook Rearrangement | Brook Rearrangement | Brook Rearrangement, Rubottom Oxidation |  | 0 |  |
